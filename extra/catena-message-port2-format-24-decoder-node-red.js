...
Name:   catena-message-port2-format-24-decoder-node-red.js

Function:
    Decode port 0x02 format 0x24 messages for Node-RED.
...
if (result === null) {
    ...
    var eMsg = "not port 2/fmt 0x24! port=" + msg.port.toString();
    if (port === 2) {
...
msg.local =
    {
        nodeType: "Catena FED3",
        platformType: "Catena 4610",
        radioType: "Murata",
        applicationName: "Pellet Feeder fmt 0x24"
    };
